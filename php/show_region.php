<?php
	...
	$res = mysqli_query($connection,'SELECT events.title,places.coords,places.region_bigMap,events.animation,events.anim_coords FROM places INNER JOIN events ON places.id_place=events.place_id WHERE events.events_id='.$_POST['i_id']);
